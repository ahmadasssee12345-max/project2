const products = [
    { id: 1, cat: 'hardware', name: 'Steam Deck OLED', price: 580, descriptive: 'جهاز ألعاب محمول يشغل ألعاب الكمبيوتر الضخمة بشاشة OLED مبهرة.', img: 'https://tse3.mm.bing.net/th/id/OIP.4ITmRadYW77sPMtvc_v4QQHaEK?rs=1&pid=ImgDetMain&o=7&rm=3' },
    { id: 2, cat: 'hardware', name: 'Nintendo Switch OLED', price: 330, descriptive: 'استمتع بأفضل حصريات نينتندو بجودة شاشة رائعة في المنزل أو التنقل.', img: 'https://tse2.mm.bing.net/th/id/OIP.ubWOKmsTft1zAR8uxHRoCgHaEK?rs=1&pid=ImgDetMain&o=7&rm=3' }
];
let cart = [];
let lastOrderID = "";
